...
export default function BackupPanel() {
  ...
  const [journalPresent, setJournalPresent] = useState(() => typeof window !== "undefined" && Boolean(inspectBackupTransaction(window.localStorage)));
